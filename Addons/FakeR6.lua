-- This script was written by V0C0N. I honestly just took it so the Dash animation worked. It can be disabled
...
if plr.Character then
	if plr.Character:FindFirstChild("Humanoid").RigType == Enum.HumanoidRigType.R15 then
		RunCustomAnimation(plr.Character)
	end
end

plr.CharacterAdded:Connect(function(added)
	if added:FindFirstChild("Humanoid").RigType == Enum.HumanoidRigType.R15 then
		RunCustomAnimation(added)
	end
end)
